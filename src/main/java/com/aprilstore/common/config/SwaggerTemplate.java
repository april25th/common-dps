...
import com.aprilstore.common.model.swagger.SwaggerApiInfo;
import com.aprilstore.common.model.swagger.SwaggerPaginationResponse;
...
public class SwaggerTemplate {
    ...
    public Docket configure(SwaggerApiInfo info, TypeResolver typeResolver) {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.aprilstore.common"))
