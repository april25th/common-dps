...
import com.aprilstore.common.config.RequestAttributeConst;
import com.aprilstore.common.web.RequestDetailsLogger;
import com.aprilstore.common.web.ResponseDetailsLogger;
...
public class RequestLoggingAspect implements Ordered {
    ...
    @Around(value = "within(com.aprilstore.common..*) " +
            ...
            "&& @annotation(com.aprilstore.common.RequestLogging)")
